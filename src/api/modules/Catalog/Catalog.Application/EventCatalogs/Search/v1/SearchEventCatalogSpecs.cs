...
public class SearchEventCatalogSpecs : EntitiesByPaginationFilterSpec<EventCatalog, EventCatalogResponse>
{
    public SearchEventCatalogSpecs(SearchEventCatalogsCommand command)
        : base(command) =>
        Query
